...
class HomeScreen extends React.Component {
  ...
  static navigationOptions = () => ({
    title: "Home",
    headerTintColor: "white" //Header Navigation Bar    headerStyle: {      backgroundColor: 'orangered',      fontFamily: "Rustico-V2-Regular"    },
  });
  incrementCount() {
...
class DetailsScreen extends React.Component {
  ...
  componentDidMount() {
    AsyncStorage.getItem("@MySuperStore:key").then(string => {
